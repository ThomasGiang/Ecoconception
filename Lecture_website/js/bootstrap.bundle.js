...
!(function (t, e) {
    ...
    var ge,
        ...
        bi =
            ...
            (Te = { HIDE: "hide" + ve, HIDDEN: "hidden" + ve, SHOW: "show" + ve, SHOWN: "shown" + ve, CLICK: "click" + ve, CLICK_DATA_API: "click" + ve + Ee, KEYDOWN_DATA_API: "keydown" + ve + Ee, KEYUP_DATA_API: "keyup" + ve + Ee }),
            (Ce = "disabled"),
            (we = "show"),
            (Ie = "dropup"),
            (De = "dropright"),
            ...
            (Ke = (function () {
                ...
                return (
                                ...
                                if ((ge(t).trigger(i), !i.isDefaultPrevented())) {
                                    if (!this._inNavbar) {
                                        ...
                                        "parent" === this._config.reference
                                            ? (r = t)
                                            : gt.isElement(this._config.reference) && ((r = this._config.reference), "undefined" != typeof this._config.reference.jquery && (r = this._config.reference[0])),
                    ...
                    (l._dataApiKeydownHandler = function (t) {
                        if (
                            (/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || ge(t.target).closest(Le).length))) : be.test(t.which)) &&
        ...
        Ci =
            ...
            (An = (function () {
                ...
                return (
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            sn(i).data(this.constructor.DATA_KEY, this),
                                ...
                                (this._popper = new pe(this.element, i, {
                                    placement: s,
                                    modifiers: { offset: { offset: this.config.offset }, flip: { behavior: this.config.fallbackPlacement }, arrow: { element: Tn }, preventOverflow: { boundariesElement: this.config.boundary } },
                                    onCreate: function (t) {
                    ...
                    (t._getConfig = function (t) {
                        return (
                            "number" == typeof (t = c({}, this.constructor.Default, sn(this.element).data(), t)).delay && (t.delay = { show: t.delay, hide: t.delay }),
        ...
        wi =
            ...
            (jn = c({}, Ci.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' })),
